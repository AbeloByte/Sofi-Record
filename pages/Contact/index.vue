...
<section class="text-gray-600 body-font relative w-[80%] mx-auto">
    <h1 className="text-center text-4xl font-bold py-10 text-white pt-20">Contact <span className="text-[#FF3600]">Us</span> Today</h1>
